...
public class AdminMainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void startRecycleView() {
        mFoodItemAdapter = new FoodItemAdapter(mFoodItems, AdminMainActivity.this, true);
        mRecycleView.setAdapter(mFoodItemAdapter);
        mRecycleView.setLayoutManager(new GridLayoutManager(AdminMainActivity.this, 2));
    }
    ...
    private void initViews() {
        ...
        mCartBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AdminMainActivity.this, EditFoodItemActivity.class));
            }
        });
        ...
        mMyOrdersBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AdminMainActivity.this, AllOrdersActivity.class));
            }
        });
    }
